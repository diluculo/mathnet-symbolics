...
module Evaluate =
    ...
    let fapply f u =
        ...
        | Acsc, Real x -> Real (Math.Asin(1.0/x))
        | Acsc, Complex x -> Complex (Complex.Asin(Complex.One/x))
        | Asec, Real x -> Real (Math.Acos(1.0/x))
        | Asec, Complex x -> Complex (Complex.Acos(Complex.One/x))
        | Acot, Real x -> Real (Math.Atan(1.0/x))
        | Acot, Complex x -> Complex (Complex.Atan(Complex.One/x))
        ...
        | Acsch, Real x -> Real (Trig.Asinh(1.0/x))
        | Acsch, Complex x -> Complex (Trig.Asinh(Complex.One/x))
        | Asech, Real x -> Real (Trig.Acosh(1.0/x))
        | Asech, Complex x -> Complex (Trig.Acosh(Complex.One/x))
        | Acoth, Real x -> Real (Trig.Atanh(1.0/x))
        | Acoth, Complex x -> Complex (Trig.Atanh(Complex.One/x))
